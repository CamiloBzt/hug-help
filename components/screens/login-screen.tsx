...
export function LoginScreen() {
  ...
  const handleLogin = (mode: "client" | "provider") => {
    setUserMode(mode)
  }
  ...
  return (
    <div className="flex flex-1 flex-col bg-card">
      {/* Header */}
      <div className="flex flex-col items-center gap-3 px-6 pt-12 pb-8">
      ...
      <div className="flex flex-1 flex-col gap-5 px-6">
        ...
        <div className="mt-2 flex flex-col gap-2.5">
          <button
            ...
            className="flex h-12 items-center justify-center rounded-xl bg-primary text-sm font-semibold text-primary-foreground transition-colors active:bg-primary/90"
          >
          ...
          <button
            ...
            className="flex h-12 items-center justify-center rounded-xl border border-primary bg-transparent text-sm font-semibold text-primary transition-colors active:bg-primary/5"
          >
            Entrar como Cliente
          </button>
        </div>
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex h-12 flex-1 items-center justify-center gap-2 rounded-xl border border-input bg-card text-sm font-medium text-foreground transition-colors active:bg-muted"
          >
